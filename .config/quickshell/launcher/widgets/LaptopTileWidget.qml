...
// Tile "Laptop": alterna entre monitor externo (auto) e só a tela do notebook (HDMI desligado).
Item {
    id: root
    anchors.fill: parent
    ...
    property bool laptopOnly: false
    ...
    Item {
        ...
        LiquidGlass {
            ...
            tint: root.laptopOnly ? "#34c759" : "#ffffff"
            tintAlpha: root.laptopOnly ? 0.22 : (tileMouse.containsMouse ? 0.18 : 0.10)
            widgetX: full.x
            widgetY: full.y
        ...
        Rectangle {
            ...
            height: width
            radius: width / 2
            color: root.laptopOnly ? Qt.rgba(52/255, 199/255, 89/255, 0.45) : Qt.rgba(1, 1, 1, 0.16)
            border.width: 1
            border.color: root.laptopOnly ? "#34c759" : Qt.rgba(1, 1, 1, 0.30)
