...
Item {
    ...
    readonly property bool isGaming: GlassTheme.gaming
    ...
    Item {
        ...
        Item {
            ...
            Rectangle {
                ...
                height: width
                radius: width / 2
                color: root.isGaming ? Qt.rgba(1, 1, 1, 0.30) : Qt.rgba(1, 1, 1, 0.12)
                border.width: 1
                border.color: root.isGaming ? Qt.rgba(1, 1, 1, 0.45) : Qt.rgba(1, 1, 1, 0.15)
                ...
                Image {
                    ...
                    height: width
                    source: "file://" + GlassTheme.home + "/.config/quickshell/assets/icons/gamecontroller.svg"
                    fillMode: Image.PreserveAspectFit
                    opacity: root.isGaming ? 1.0 : 0.70
        ...
        Item {
            ...
            Row {
                ...
                Rectangle {
                    width: 34; height: 34
                    radius: 17
                    color: root.isGaming ? Qt.rgba(1, 1, 1, 0.28) : Qt.rgba(1, 1, 1, 0.12)
                    border.width: 1
                    border.color: root.isGaming ? Qt.rgba(1, 1, 1, 0.40) : Qt.rgba(1, 1, 1, 0.14)
                    ...
                    Image {
                        ...
                        source: "file://" + GlassTheme.home + "/.config/quickshell/assets/icons/gamecontroller.svg"
                        fillMode: Image.PreserveAspectFit
                        opacity: root.isGaming ? 1.0 : 0.75
                    }
                }
