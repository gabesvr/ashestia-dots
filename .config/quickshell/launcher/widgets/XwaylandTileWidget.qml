    ...
    Item {
        ...
        Item {
            ...
            Rectangle {
                ...
                height: width
                radius: width / 2
                color: root.isXwayland ? Qt.rgba(1, 1, 1, 0.30) : Qt.rgba(1, 1, 1, 0.12)
                border.width: 1
                border.color: root.isXwayland ? Qt.rgba(1, 1, 1, 0.45) : Qt.rgba(1, 1, 1, 0.15)
                ...
                Image {
                    ...
                    opacity: root.isXwayland ? 1.0 : 0.70
        ...
        Item {
            ...
            Row {
                ...
                Rectangle {
                    width: 34; height: 34
                    radius: 17
                    color: root.isXwayland ? Qt.rgba(1, 1, 1, 0.28) : Qt.rgba(1, 1, 1, 0.12)
                    border.width: 1
                    border.color: root.isXwayland ? Qt.rgba(1, 1, 1, 0.40) : Qt.rgba(1, 1, 1, 0.14)
                    ...
                    Image {
                        ...
                        source: "file:///home/gabriel/.config/quickshell/assets/icons/monitor.svg"
                        fillMode: Image.PreserveAspectFit
                        opacity: root.isXwayland ? 1.0 : 0.75
                    }
                }
                ...
                Column {
                    ...
                    Text {
                        text: root.isXwayland ? "Bridge Enabled" : "Wayland Native"
                        color: "#ffffff"
                        opacity: 0.70
                        font.family: sfRegular.name
                        font.pixelSize: 9
